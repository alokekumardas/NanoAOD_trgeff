...
// Fri Nov 18 06:33:42 2022 by ROOT version 6.22/06
// from TTree Events/Events
// found on file: root://cms-xrd-global.cern.ch//store/data/Run2022F/EGamma/NANOAOD/PromptNanoAODv10_v1-v2/2520000/0b712b83-6cdd-4c3c-b7e6-35ac3fd3873e.root
//////////////////////////////////////////////////////////

#ifndef NanAODEgammaReader_h
#define NanAODEgammaReader_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         CorrT1METJet_area[51];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_eta[51];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_muonSubtrFactor[51];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_phi[51];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_rawPt[51];   //[nCorrT1METJet]
   ...
   Int_t           Electron_fsrPhotonIdx[8];   //[nElectron]
   ...
   Int_t           FsrPhoton_electronIdx[3];   //[nFsrPhoton]
   ...
   UInt_t          nJet;
   Float_t         Jet_area[89];   //[nJet]
   Float_t         Jet_btagCSVV2[89];   //[nJet]
   Float_t         Jet_btagDeepB[89];   //[nJet]
   Float_t         Jet_btagDeepCvB[89];   //[nJet]
   Float_t         Jet_btagDeepCvL[89];   //[nJet]
   Float_t         Jet_btagDeepFlavB[89];   //[nJet]
   Float_t         Jet_btagDeepFlavCvB[89];   //[nJet]
   Float_t         Jet_btagDeepFlavCvL[89];   //[nJet]
   Float_t         Jet_btagDeepFlavQG[89];   //[nJet]
   Float_t         Jet_chEmEF[89];   //[nJet]
   Float_t         Jet_chHEF[89];   //[nJet]
   Float_t         Jet_eta[89];   //[nJet]
   Float_t         Jet_hfsigmaEtaEta[89];   //[nJet]
   Float_t         Jet_hfsigmaPhiPhi[89];   //[nJet]
   Float_t         Jet_mass[89];   //[nJet]
   Float_t         Jet_muEF[89];   //[nJet]
   Float_t         Jet_muonSubtrFactor[89];   //[nJet]
   Float_t         Jet_neEmEF[89];   //[nJet]
   Float_t         Jet_neHEF[89];   //[nJet]
   Float_t         Jet_phi[89];   //[nJet]
   Float_t         Jet_pt[89];   //[nJet]
   Float_t         Jet_rawFactor[89];   //[nJet]
   Int_t           Jet_electronIdx1[89];   //[nJet]
   Int_t           Jet_electronIdx2[89];   //[nJet]
   Int_t           Jet_hfadjacentEtaStripsSize[89];   //[nJet]
   Int_t           Jet_hfcentralEtaStripSize[89];   //[nJet]
   Int_t           Jet_jetId[89];   //[nJet]
   Int_t           Jet_muonIdx1[89];   //[nJet]
   Int_t           Jet_muonIdx2[89];   //[nJet]
   Int_t           Jet_nElectrons[89];   //[nJet]
   Int_t           Jet_nMuons[89];   //[nJet]
   UChar_t         Jet_nConstituents[89];   //[nJet]
   ...
   Int_t           LowPtElectron_electronIdx[8];   //[nLowPtElectron]
   ...
   UChar_t         Jet_cleanmask[89];   //[nJet]
   UChar_t         LowPtElectron_cleanmask[8];   //[nLowPtElectron]
   ...
   Bool_t          HLT_EphemeralPhysics_TestMasking;
   ...
   TBranch        *b_HLT_EphemeralPhysics_TestMasking;   //!
 ...
 //  NanAODEgammaReader(TTree *tree=0);
   virtual ~NanAODEgammaReader();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   //virtual void     Loop();
   virtual void     Loop(int ac, char** av);
